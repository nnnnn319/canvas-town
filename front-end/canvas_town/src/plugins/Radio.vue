<template>
  <div class="location " @click="playAudio">
    <audio  ref="audio"  loop :src="musicUrl"> </audio>
    <div class="svgs">
...
export default {
   ...
   data() {
     return {
       musicUrl:'https://music.163.com/song/media/outer/url?id=547727897'
     }
   },
   methods: {
     playAudio(){
     if (this.$refs.audio.paused){
      ...
      var sfa = document.querySelectorAll(".speaker__front");
      var sta = document.querySelectorAll(".speaker__top");
      var sba = document.querySelectorAll(".speaker__back");
      var sla = document.querySelectorAll(".speaker__left");
      var sra = document.querySelectorAll(".speaker__right");
...
.base__front {
  ...
  background-image: linear-gradient(to right, #7142BC, #A2A2D6);
}
.base__back {
...
.bb__front {
  ...
  background-image: linear-gradient(to bottom, #7677C8 2.8vw, #A2A2D6 3.4vw);
}
.bb__back {
...
.bb__right {
  ...
  background-image: linear-gradient(to bottom, #7677C8, #A2A2D6);
}
.bb__left {
...
.bb__top {
  ...
  background-image: linear-gradient(to right, #7677C8, #A2A2D6);
}
.bb__bottom {
  background-color: #5E6DCD;
}
...
.bf__right {
  ...
  background-image: linear-gradient(to bottom, #23BAA8, #12a9a0); */
   background-image: -webkit-gradient(linear, left top, left bottom, from(#23BAA8), to(#12a9a0));
  background-image: linear-gradient(to bottom, #8B50BD, #4D7BC3);
}
.bf__left {
  background-color: #5E6DCD;
}
.bf__top {
  ...
  background-image: -webkit-gradient(linear, left top, right top, from(#4897D3), to(#31D1F6));
  background-image: linear-gradient(to right, #8020AE, #9D9DD4);
}
.bf__bottom {
  background-color: #5E6DCD;
}
...
.shadow::before, .shadow::after {
  ...
  background-image: -webkit-gradient(linear, left top, right top, from(#0DF2DE), to(#06D9BE));
  background-image: linear-gradient(to right, #0DF2DE, #06D9BE);
}
.shadow::after {
  height: 100%;
  bottom: 0;
